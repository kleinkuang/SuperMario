...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set ft_ready [ create_bd_port -dir O ft_ready ]
  set ft_start [ create_bd_port -dir O ft_start ]
  set nrst [ create_bd_port -dir I nrst ]
  set wr_clk [ create_bd_port -dir O wr_clk ]
  ...
  connect_bd_net -net wr_en_0_1 [get_bd_ports wr_en] [get_bd_pins ft_tx_0/wr_en]
