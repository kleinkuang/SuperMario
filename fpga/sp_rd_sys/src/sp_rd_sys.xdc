...
set_property IOSTANDARD LVCMOS12                [get_ports LED_ERROR]
set_property PACKAGE_PIN AV34                   [get_ports LED_ERROR]
...
# ----------------------------------------------------------------
# ft_start -> readout
set_false_path -from [get_clocks FT601Q_ft_clk] -to [get_clocks -of_objects [get_pins bd_sys_i/clk_wiz_1/inst/mmcme4_adv_inst/CLKOUT0]]
