...
class Debug_Command(object):
    ...
    def list_serial(self, show=False):
        ...
        for port in ports:
            if('Silicon Labs Dual CP2105 USB to UART Bridge: Standard COM Port' in port.description):
                port_name.append('VCU118')
    ...
    def open_serial(self, port='COM6'):
        ...
        try:
            ...
            e_msg = str(e)
            if('OSError' in e_msg):
                self.error('Timeout !\nMake sure LacewingPXE is powered on\n')
...
if __name__ == "__main__":
    ...
    mcu_debug.print("\n")
    mcu_debug.print("---- Command Line Interface for BlackPearl ----\n")
